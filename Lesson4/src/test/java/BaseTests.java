...
public abstract class BaseTest {
    ...
    public final static String PROPERTIES = "src/test/java/Lesson4/resources/application.properties";
    public final static String PATH_TO_IMAGE = "src/test/java/Lesson4/resources/JPEG-Image.jpeg";
    public final static String PATH_TO_IMAGE_MICRO = "src/test/java/Lesson4/resources/PNG_Image.png";
    public final static String PATH_TO_GIF = "src/test/java/Lesson4/resources/GIF-Image.gif";
    public final static String PATH_TO_DOC = "src/test/java/Lesson4/resources/testDOCX.docx";
    public final static String PATH_TO_MP3 = "src/test/java/Lesson4/resources/music.mp3";
    public final static String PATH_TO_VIDEO = "src/test/java/Lesson4/resources/video.mp4";
